  ...
  const socialLinks = [
    {
      label: "GitHub",
      icon: "💻",
      placeholder: "https://github.com/le-Affan",
      display: "le-Affan",
    },
    {
      label: "LinkedIn",
      icon: "🔗",
      placeholder: "https://www.linkedin.com/in/affan-shaikh-ml/",
      display: "affan-shaikh-ml",
    },
    { label: "WhatsApp", icon: "📱", placeholder: "+91 9167870478" },
    {
      label: "LeetCode",
      icon: "⚡",
      placeholder: "https://leetcode.com/u/le-Affan/",
      display: "le-Affan",
    },
    ...
    <div className="p-4 space-y-3 max-h-96 overflow-y-auto">
      ...
      */}
      ...
      <div className="border-2 border-pixel-pink p-3">
        <h3 className="text-xs font-bold text-pixel-pink mb-2">
          CONNECT WITH ME
        </h3>
