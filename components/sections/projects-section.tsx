...
const projects: Project[] = [
  ...
  },
  {
    ...
    aboutPoints: [
      ...
      "Developed result analysis to surface performance differences between model variants over time.",
    ],
  },
  {
    name: "GitConnect",
        ...
        {projects.map((project, idx) => (
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-xs font-bold text-pixel-pink">
                {project.name}
              </h3>
            </div>
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h2
                    className="text-lg font-bold text-pixel-yellow mb-2"
                    style={{ textShadow: "2px 2px 0 rgba(0,0,0,0.8)" }}
                  >
                    {selectedProject.name}
                  </h2>
                  <p className="text-xs text-pixel-cyan">
